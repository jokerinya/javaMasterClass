...
//        }
    ...
    private static boolean addInOrder(LinkedList<String> linkedList, String newCity){
        ...
        while (stringListIterator.hasNext()){
            // compareTo= 0 for same, Positive for smaller values, Negative for bigger values,
            ...
            if (comparison==0){
                ...
                // newCity should come before this one.
        ...
        // came until the end of the linkedlist
        stringListIterator.add(newCity);
        return true;
    }
            ...
            switch (action){
                ...
                case 2:
                    ...
                    if (listIterator.hasPrevious()){
                        ...
                        System.out.println("We are at the start now");
                        goingForward = true;
                    }
                    break;
                case 3:
